...
impl ReplayRecord {
    ...
    pub fn decode(bytes: &[u8], version: u32) -> Self {
        match version {
            ...
            6 => {
                let wire_format: v6::ReplayWireFormatV6 =
                    bincode::decode_from_slice(bytes, bincode::config::standard())
                        .unwrap()
                        .0;
                wire_format.into()
            ...
            7 => {
                let wire_format: v7::ReplayWireFormatV7 =
                    bincode::decode_from_slice(bytes, bincode::config::standard())
                        .unwrap()
                        .0;
                wire_format.into()
