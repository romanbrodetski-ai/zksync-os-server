...
cargo run --release -- --config ./local-chains/v31.0/default/config.json
```
...
For contract addresses, please refer to `genesis` section of the [config.json](./config.json).
